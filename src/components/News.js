...
export default class News extends Component {// articles = [here will the sampleData.json]
    ...
    fetchDataFromApi = async () => {
        ...
        try {
            ...
            // todo == {uncomment thsese comment to activate the live newsapi} console.log(data);
